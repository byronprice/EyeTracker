function [] = WaveletICAMot(filename,imInds)
%WaveletPCA.m
%   Detailed explanation goes here
savefilename = filename(1:end-4);
savefilename = strcat(savefilename,'-wvlticamot.mat');
...
if exist(savefilename,'file') == 2
    ...
    icaRep(1,:) = (WTinv*(C(:)-mu))'; % to go the other way T*W'*icaRep'+mu
    prevIm = im;
    ...
    newName = strcat(newName,'-wvlticamot.mat');
